    ...
    def __init__(self):
        ...
        try:
            ...
            with open('.credentials', 'r') as credential_file:
                ...
                self.username = self.credentials_dic['azizbek']
                self.password = self.credentials_dic['@xQ6$ZEVb*$iccZ']
                self.apikey = self.credentials_dic['DlG6xeD3ni5z1aGYq3HCDuYDkb200sPp']
